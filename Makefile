...
DEFS := NUM_WRITERS=8 NUM_READERS=256 SLEEP_READ=10 SLEEP_WRITE=100000 NUM_UPDATES=1000
...
#DEFS := NUM_WRITERS=256 NUM_READERS=4 SLEEP_READ=10 SLEEP_WRITE=100000 NUM_UPDATES=1000
...
.PHONY: jonas_rw posix_rw all clean

all: jonas_rw posix_rw

clean:
	-$(RM) $(POSIX_OBJS) $(MY_OBJS)
	-$(RM) posix_rw jonas_rw
